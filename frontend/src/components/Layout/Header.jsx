  ...
  return (
    <>
      ...
      <div
        ...
        } transition hidden 800px:flex items-center justify-between w-full bg-[#FA5CA1] h-[70px]`}
      >
        <div
              ...
              {searchData && (
                <div className="absolute bg-[#fff] z-10 shadow w-full left-0 p-3">
                  {searchData.map((i) => {
                    ...
                    return (
                      <Link className="link" to={`/product/${Product_name}`}>
            ...
            <div className="flex w-full justify-center">
              {isAuthenticated ? (
                ...
                <>
                  ...
                  <Link className="link" to="/sign-up" className="text-[18px] text-[#000000b7]">
                    Sign up{" "}
                  </Link>
                </>
              )}
