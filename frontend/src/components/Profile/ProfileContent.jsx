...
import MeasurementsTable from './showmeasurments';
...
const ProfileContent = ({ active }) => {
    ...
    return (
        <div className="w-full">
            ...
            {/* Add Measurement */}
            {active === 8 && <AddMeasurement />} {/* Render AddMeasurement component when active is 8 */}

            {active === 9 && <MeasurementsTable />}
        </div>
    );
};
    ...
    const columns = [
...

        {
            ...
            renderCell: (params) => {
                return (
                    <>
                        <Link className="link" to={`/user/order/${params.id}`}>
                            <Button>
    ...
    const columns = [
...

        {
            ...
            renderCell: (params) => {
                return (
                    <>
                        <Link className="link" to={`/user/track/order/${params.id}`}>
                            <Button>
