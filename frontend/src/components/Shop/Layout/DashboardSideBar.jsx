...
const DashboardSideBar = ({ active }) => {
 ...
 <div className="w-full flex items-center p-4">
            ...
            <div className="w-full flex items-center p-4">
                <Link to="/dashboard-add-design" className="w-full flex items-center link">
                    <VscNewFile
                        size={30}
            ...
            <div className="w-full flex items-center p-4">
                <Link className="link" to="/dashboard-create-event" className="w-full flex items-center">
                    <VscNewFile
                        size={30}
                        color={`${active === 6 ? "crimson" : "#555"}`}
                    />
            ...
            {/* <div className="w-full flex items-center p-4">
                <Link className="link" to="/dashboard-coupouns" className="w-full flex items-center">
                    <AiOutlineGift
                        size={30}
            ...
            {/* <div className="w-full flex items-center p-4">
                <Link className="link" to="/dashboard-refunds" className="w-full flex items-center">
